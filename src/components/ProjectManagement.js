...
class ProjectManagement extends React.Component {
    ...
    validate() {
        const {projectName, projectId, startingDate, sprintLength, startingFactor} = this.state;
    ...
    handleSaveProjectButton = () => {
        ...
        api.fetch(
            api.endpoints.updateProject(this.state.projectId, data),
            () => {
                this.props.managementCallback()
            });
    };

    handleCloseProjectManagementButton = () => {
        this.props.managementCallback();
    }
    ...
    render() {
        ...
        const {
            startingDate, sprintLength, startingFactor,
        } = this.state;
        const {
                ...
                <Grid container spacing={0} justify='center'>
                    ...
                    <Grid item xs={6}>
                        <div className={classes.projectConfig}>
                            ...
                            <Button
                                disabled={!valid}
                                onClick={this.handleSaveProjectButton}
                                color="primary"
                                variant="contained"
                                className={classes.saveProjectButton}
                            >
                                save project
                            </Button>
                            ...
                            <br />
                            <Button
                                onClick={this.handleCloseProjectManagementButton}
                                color="primary"
                                variant="contained"
